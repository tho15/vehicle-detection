...
# those functions are mostly from Udacity lessons
...
# Define a function you will pass an image  and the list of windows
...
def find_cars_d(img, color_space, window_size, cells_step,
		      ystart, ystop, scale, svc, X_scaler,
			  hog_channel, orient, pix_per_cell, cell_per_block,
			  spatial_feat, spatial_size, hist_feat, hist_bins):
	...
	ctrans_tosearch = cv2.cvtColor(img_tosearch, eval('cv2.COLOR_RGB2'+color_space))
	...
	cells_per_step = cells_step  # Instead of overlap, define how many cells to step
